...
function OffersFeedContent() {
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-emerald-900">{t("helpOffersFeed")}</h1>
        <p className="text-sm text-muted-foreground">{t("helpOffersFeedDesc")}</p>
      </div>
      ...
      <p className="mb-4 text-sm text-muted-foreground">{total} {t("offersCount")}</p>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center">
          <p className="text-lg font-medium text-gray-500">{t("noOffersNow")}</p>
        </div>
      ) : (
        <div className="grid gap-4 sm:grid-cols-2">
          {posts.map((post) => (
